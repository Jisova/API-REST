...
abstract class BaseResult implements ResultInterface
{
    ...
    /**
     * Recuperar los resultados de la consulta. Normalmente una serie de
     * filas de datos individuales, que pueden ser una 'matriz', una
     * 'objeto', o un nombre de clase personalizado.
     *
    ...
    public function getResultArray(): array
    {
        ...
        // En caso de que el almacenamiento en cache de consultas este activado, la variable result_id
        // no sera un recurso valido por lo que simplemente devolveremos un recurso vacio
        // matriz.
        if (is_bool($this->resultID) || ! $this->resultID) {
            return [];
        }
