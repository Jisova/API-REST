...
abstract class BasePreparedQuery implements PreparedQueryInterface
{
    ...
    /**
     * Prepara la consulta en la base de datos y guarda la conexion.
     *informacion necesaria para ejecutar la consulta posteriormente.
     *
     * NOTA: Esta version se basa en codigo SQL. Las clases infantiles deben
     * anular este metodo.
     *
     * @return mixed
     */
